...
static int itop4412_pwm_ioremap(void)
{
...
static int itop4412_pwm_iounmap(void)
{
	iounmap(pwmbase);
	iounmap(gpd0con);
...
static int __init demo_init(void)
{
	...
	// 申请注册设备号
	ret = alloc_chrdev_region(&devno, minor, count, "itop4412_pwm");
	if(ret)
	{
